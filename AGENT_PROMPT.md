# Paste this to the Cursor agent (chat or rules)

---
**Every time you finish a message, give me short voice feedback (at most 5 words) by calling the `feedback_speaker` tool.**
Examples:
